...
public class PoseEstimator : MonoBehaviour
{
    ...
    public Vector2Int webcamDims = new Vector2Int(1920, 1080);
    ...
    IEnumerator Start()
    {
        if (useWebcam)
        {
            ...
            Debug.Log(videoDims.x + " " + videoDims.y);
        }
        else
        {
            // Update the videoDims.y
        ...
        // Initialize the videoScreen  ->  ���� ��ũ���� �ʿ��� �ּ�ó��
        //InitializeVideoScreen(videoDims.x, videoDims.y, useWebcam);

        // Adjust the camera based on the source video dimensions -> ī�޶� �̵��ʿ��� �ּ�
        //InitializeCamera();
